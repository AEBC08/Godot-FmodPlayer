...
public class AudioImporterFmod
{
	// Engine object used for calling engine methods
	protected EditorImportPlugin _object;

	public AudioImporterFmod() : this(NativeName)
	{
	}
	protected AudioImporterFmod(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected AudioImporterFmod(Variant variant) : this((EditorImportPlugin) variant)
	{
	}
	protected AudioImporterFmod([NotNull] EditorImportPlugin @object)
	{
		_object = @object;
	}

	public static implicit operator EditorImportPlugin(AudioImporterFmod self) => self?._object;
	public static implicit operator Variant(AudioImporterFmod self) => self?._object;
	public static explicit operator AudioImporterFmod(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

	public class PropertyName : EditorImportPlugin.PropertyName
	{

	}

	public class MethodName : EditorImportPlugin.MethodName
	{

	}

	public class SignalName : EditorImportPlugin.SignalName
	{

	}

	private static readonly StringName NativeName = "AudioImporterFmod";

	#region Inherited Methods

	public Godot.Error AppendImportExternalResource(string @path, Godot.Collections.Dictionary @custom_options = null, string @custom_importer = "", Variant @generator_parameters = default)
	{
		@custom_options ??= new();
		return _object.AppendImportExternalResource(@path, @custom_options, @custom_importer, @generator_parameters);
	}
