...
public class FmodAudioBus
{
	// Engine object used for calling engine methods
	protected RefCounted _object;

	public FmodAudioBus() : this(NativeName)
	{
	}
	protected FmodAudioBus(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected FmodAudioBus(Variant variant) : this((RefCounted) variant)
	{
	}
	protected FmodAudioBus([NotNull] RefCounted @object)
	{
		_object = @object;
	}

	public static implicit operator RefCounted(FmodAudioBus self) => self?._object;
	public static implicit operator Variant(FmodAudioBus self) => self?._object;
	public static explicit operator FmodAudioBus(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	public class PropertyName : RefCounted.PropertyName
	{
		...
		public static readonly StringName Solo = "solo";
		public static readonly StringName Bypass = "bypass";
	}

	public class MethodName : RefCounted.MethodName
	{
		public static readonly StringName InitBus = "init_bus";
		...
		public static readonly StringName IsMute = "is_mute";
		public static readonly StringName ApplyMute = "apply_mute";
		public static readonly StringName SetSolo = "set_solo";
		public static readonly StringName IsSolo = "is_solo";
		public static readonly StringName SetBypass = "set_bypass";
		public static readonly StringName IsBypass = "is_bypass";
		public static readonly StringName AddEffect = "add_effect";
		public static readonly StringName RemoveEffect = "remove_effect";
		public static readonly StringName GetEffect = "get_effect";
	}
	...
	private static readonly StringName NativeName = "FmodAudioBus";
	...
	public bool Solo
	{
		get => (bool)_object.Get(PropertyName.Solo);
		set => _object.Set(PropertyName.Solo, value);
	}
	...
	public void InitBus(string @name, FmodChannelGroup @parent = default)
	{
		_object.Call(MethodName.InitBus, @name, @parent);
	}

	public void SetParent(FmodChannelGroup @parent)
	{
		_object.Call(MethodName.SetParent, @parent);
	}

	public FmodChannelGroup GetBus()
	{
		return (FmodChannelGroup)_object.Call(MethodName.GetBus);
	}

	public FmodChannelGroup GetParent()
	{
		return (FmodChannelGroup)_object.Call(MethodName.GetParent);
	}
	...
	public bool IsMute()
	{
		return (bool)_object.Call(MethodName.IsMute);
	}

	public void ApplyMute(bool @_unnamed_arg0)
	{
		_object.Call(MethodName.ApplyMute, @_unnamed_arg0);
	}

	public void SetSolo(bool @solo)
	{
		_object.Call(MethodName.SetSolo, @solo);
	}

	public bool IsSolo()
	{
		return (bool)_object.Call(MethodName.IsSolo);
	}
	...
	{
		return (bool)_object.Call(MethodName.IsBypass);
	}

	public void AddEffect(FmodAudioEffect @effect, int @index)
	{
		_object.Call(MethodName.AddEffect, @effect, @index);
	}

	public void RemoveEffect(int @index)
	{
		_object.Call(MethodName.RemoveEffect, @index);
	}

	public FmodAudioEffect GetEffect(int @index)
	{
		return (FmodAudioEffect)_object.Call(MethodName.GetEffect, @index);
	}
