...
public class FmodAudioBusLayout
{
	// Engine object used for calling engine methods
	protected Resource _object;

	public FmodAudioBusLayout() : this(NativeName)
	{
	}
	protected FmodAudioBusLayout(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected FmodAudioBusLayout(Variant variant) : this((Resource) variant)
	{
	}
	protected FmodAudioBusLayout([NotNull] Resource @object)
	{
		_object = @object;
	}

	public static implicit operator Resource(FmodAudioBusLayout self) => self?._object;
	public static implicit operator Variant(FmodAudioBusLayout self) => self?._object;
	public static explicit operator FmodAudioBusLayout(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	{
		public static readonly StringName CreateAudioBus = "create_audio_bus";
		public static readonly StringName GetAudioBus = "get_audio_bus";
		public static readonly StringName HasAudioBus = "has_audio_bus";
		public static readonly StringName RemoveAudioBus = "remove_audio_bus";
		public static readonly StringName SetBusVolume = "set_bus_volume";
		public static readonly StringName GetBusVolume = "get_bus_volume";
		public static readonly StringName SetBusSolo = "set_bus_solo";
		public static readonly StringName BusIsSolo = "bus_is_solo";
		public static readonly StringName SetBusMute = "set_bus_mute";
		public static readonly StringName BusIsMute = "bus_is_mute";
		public static readonly StringName SetBusBypass = "set_bus_bypass";
		public static readonly StringName BusIsBypass = "bus_is_bypass";
		...
		public static readonly StringName SyncFromAudioServer = "sync_from_audio_server";
	}
	...
	private static readonly StringName NativeName = "FmodAudioBusLayout";
	...
	public void CreateAudioBus(string @name, FmodAudioBus @parent = default)
	{
		_object.Call(MethodName.CreateAudioBus, @name, @parent);
	}

	public FmodAudioBus GetAudioBus(string @name)
	{
		return (FmodAudioBus)_object.Call(MethodName.GetAudioBus, @name);
	}

	public bool HasAudioBus(string @name)
	{
		return (bool)_object.Call(MethodName.HasAudioBus, @name);
	}

	public void RemoveAudioBus(string @name)
	{
		_object.Call(MethodName.RemoveAudioBus, @name);
	}

	public void SetBusVolume(string @name, float @volume_db)
	{
		_object.Call(MethodName.SetBusVolume, @name, @volume_db);
	}

	public float GetBusVolume(string @name)
	{
		return (float)_object.Call(MethodName.GetBusVolume, @name);
	}

	public void SetBusSolo(string @name, bool @mute)
	{
		_object.Call(MethodName.SetBusSolo, @name, @mute);
	}

	public bool BusIsSolo(string @name)
	{
		return (bool)_object.Call(MethodName.BusIsSolo, @name);
	}

	public void SetBusMute(string @name, bool @mute)
	{
		_object.Call(MethodName.SetBusMute, @name, @mute);
	}

	public bool BusIsMute(string @name)
	{
		return (bool)_object.Call(MethodName.BusIsMute, @name);
	}

	public void SetBusBypass(string @name, bool @mute)
	{
		_object.Call(MethodName.SetBusBypass, @name, @mute);
	}

	public bool BusIsBypass(string @name)
	{
		return (bool)_object.Call(MethodName.BusIsBypass, @name);
	}

	public void AddBusEffect(string @bus_name, FmodAudioEffect @effect, int @index = 0)
	{
		_object.Call(MethodName.AddBusEffect, @bus_name, @effect, @index);
	}

	public void RemoveBusEffect(string @bus_name, int @index)
	{
		_object.Call(MethodName.RemoveBusEffect, @bus_name, @index);
	}

	public FmodAudioEffect GetBusEffect(string @bus_name, int @index)
	{
		return (FmodAudioEffect)_object.Call(MethodName.GetBusEffect, @bus_name, @index);
	}

	public void SyncFromAudioServer()
	{
		_object.Call(MethodName.SyncFromAudioServer);
	}
	...
	{
		return _object.DuplicateDeep((int)@deep_subresources_mode);
	}
