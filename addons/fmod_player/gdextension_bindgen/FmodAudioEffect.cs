...
public class FmodAudioEffect
{
	// Engine object used for calling engine methods
	protected Resource _object;

	public FmodAudioEffect() : this(NativeName)
	{
	}
	protected FmodAudioEffect(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected FmodAudioEffect(Variant variant) : this((Resource) variant)
	{
	}
	protected FmodAudioEffect([NotNull] Resource @object)
	{
		_object = @object;
	}

	public static implicit operator Resource(FmodAudioEffect self) => self?._object;
	public static implicit operator Variant(FmodAudioEffect self) => self?._object;
	public static explicit operator FmodAudioEffect(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	{
		public static readonly StringName ApplyTo = "apply_to";
		public static readonly StringName RemoveFromBus = "remove_from_bus";
	...
	private static readonly StringName NativeName = "FmodAudioEffect";
	...
	public void ApplyTo(FmodChannelGroup @bus)
	{
		_object.Call(MethodName.ApplyTo, @bus);
	}

	public void RemoveFromBus(FmodChannelGroup @bus)
	{
		_object.Call(MethodName.RemoveFromBus, @bus);
	}
