...
public class FmodAudioPreviewInspector
{
	// Engine object used for calling engine methods
	protected EditorInspectorPlugin _object;

	public FmodAudioPreviewInspector() : this(NativeName)
	{
	}
	protected FmodAudioPreviewInspector(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected FmodAudioPreviewInspector(Variant variant) : this((EditorInspectorPlugin) variant)
	{
	}
	protected FmodAudioPreviewInspector([NotNull] EditorInspectorPlugin @object)
	{
		_object = @object;
	}

	public static implicit operator EditorInspectorPlugin(FmodAudioPreviewInspector self) => self?._object;
	public static implicit operator Variant(FmodAudioPreviewInspector self) => self?._object;
	public static explicit operator FmodAudioPreviewInspector(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

	public class PropertyName : EditorInspectorPlugin.PropertyName
	{

	}

	public class MethodName : EditorInspectorPlugin.MethodName
	{

	}

	public class SignalName : EditorInspectorPlugin.SignalName
	{

	}

	private static readonly StringName NativeName = "FmodAudioPreviewInspector";

	#region Inherited Methods

	public void AddCustomControl(Control @control)
	{
		_object.AddCustomControl(@control);
	}

	public void AddPropertyEditor(string @property, Control @editor, bool @add_to_end = false, string @label = "")
	{
		_object.AddPropertyEditor(@property, @editor, @add_to_end, @label);
	}

	public void AddPropertyEditorForMultipleProperties(string @label, string[] @properties, Control @editor)
	{
		_object.AddPropertyEditorForMultipleProperties(@label, @properties, @editor);
	}
