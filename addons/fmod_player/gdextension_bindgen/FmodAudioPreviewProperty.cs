...
public class FmodAudioPreviewProperty
{
	// Engine object used for calling engine methods
	protected ColorRect _object;

	public FmodAudioPreviewProperty() : this(NativeName)
	{
	}
	protected FmodAudioPreviewProperty(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected FmodAudioPreviewProperty(Variant variant) : this((ColorRect) variant)
	{
	}
	protected FmodAudioPreviewProperty([NotNull] ColorRect @object)
	{
		_object = @object;
	}

	public static implicit operator ColorRect(FmodAudioPreviewProperty self) => self?._object;
	public static implicit operator Variant(FmodAudioPreviewProperty self) => self?._object;
	public static explicit operator FmodAudioPreviewProperty(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	private static readonly StringName NativeName = "FmodAudioPreviewProperty";
	...
	{
		get => _object.FocusBehaviorRecursive;
		set => _object.FocusBehaviorRecursive = value;
	}
	...
	{
		get => _object.MouseBehaviorRecursive;
		set => _object.MouseBehaviorRecursive = value;
	}
	...
	public GodotObject ShortcutContext
	{
	...
	{
		get => _object.AccessibilityLive;
		set => _object.AccessibilityLive = value;
	}
	...
	public void SetStream(FmodAudioStream @stream)
	{
		_object.Call(MethodName.SetStream, @stream);
	}

	public FmodAudioStream GetStream()
	{
		return (FmodAudioStream)_object.Call(MethodName.GetStream);
	}
	...
	{
		_object.SetAnchorsPreset((int)@preset, @keep_offsets);
	}
	...
	{
		_object.SetOffsetsPreset((int)@preset, (int)@resize_mode, @margin);
	}
	...
	{
		_object.SetFocusBehaviorRecursive((int)@focus_behavior_recursive);
	}
	...
	{
		return _object.FindValidFocusNeighbor((int)@side);
	}

	public void SetHSizeFlags(Control.SizeFlags @flags)
	{
		_object.SetHSizeFlags((int)@flags);
	}
	...
	{
		_object.SetVSizeFlags((int)@flags);
	}
	...
	{
		_object.SetHGrowDirection((int)@direction);
	}
	...
	{
		_object.SetVGrowDirection((int)@direction);
	}
	...
	{
		_object.SetTooltipAutoTranslateMode((int)@mode);
	}
	...
	{
		_object.SetDefaultCursorShape((int)@shape);
	}
	...
	{
		_object.SetFocusNeighbor((int)@side, @neighbor);
	}

	public Godot.NodePath GetFocusNeighbor(Side @side)
	{
		return _object.GetFocusNeighbor((int)@side);
	}
	...
	{
		_object.SetAccessibilityLive((int)@mode);
	}
	...
	{
		_object.SetMouseFilter((int)@filter);
	}
	...
	{
		_object.SetMouseBehaviorRecursive((int)@mouse_behavior_recursive);
	}
	...
	{
		_object.SetLayoutDirection((int)@direction);
	}
	...
	{
		@modulate ??= new(1.0f, 1.0f, 1.0f, 1.0f);
		_object.DrawString(@font, @pos, @text, (int)@alignment, @width, @font_size, @modulate, (int)@justification_flags, (int)@direction, (int)@orientation, @oversampling);
	}
	...
	{
		@modulate ??= new(1.0f, 1.0f, 1.0f, 1.0f);
		_object.DrawMultilineString(@font, @pos, @text, (int)@alignment, @width, @font_size, @max_lines, @modulate, (int)@brk_flags, (int)@justification_flags, (int)@direction, (int)@orientation, @oversampling);
	}
	...
	{
		@modulate ??= new(1.0f, 1.0f, 1.0f, 1.0f);
		_object.DrawStringOutline(@font, @pos, @text, (int)@alignment, @width, @font_size, @size, @modulate, (int)@justification_flags, (int)@direction, (int)@orientation, @oversampling);
	}
	...
	{
		@modulate ??= new(1.0f, 1.0f, 1.0f, 1.0f);
		_object.DrawMultilineStringOutline(@font, @pos, @text, (int)@alignment, @width, @font_size, @max_lines, @size, @modulate, (int)@brk_flags, (int)@justification_flags, (int)@direction, (int)@orientation, @oversampling);
	}
	...
	{
		_object.SetTextureRepeat((int)@mode);
	}
	...
	{
		_object.SetClipChildrenMode((int)@mode);
	}
