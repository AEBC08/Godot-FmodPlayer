...
public class FmodAudioSampleEmitter
{
	// Engine object used for calling engine methods
	protected Node _object;

	public FmodAudioSampleEmitter() : this(NativeName)
	{
	}
	protected FmodAudioSampleEmitter(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected FmodAudioSampleEmitter(Variant variant) : this((Node) variant)
	{
	}
	protected FmodAudioSampleEmitter([NotNull] Node @object)
	{
		_object = @object;
	}

	public static implicit operator Node(FmodAudioSampleEmitter self) => self?._object;
	public static implicit operator Variant(FmodAudioSampleEmitter self) => self?._object;
	public static explicit operator FmodAudioSampleEmitter(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

	public class PropertyName : Node.PropertyName
	{
		public static readonly StringName Stream = "stream";
		public static readonly StringName AutoEmit = "auto_emit";
	}
	...
	public class MethodName : Node.MethodName
	{
		...
		public static readonly StringName SetAutoEmit = "set_auto_emit";
		public static readonly StringName IsAutoemitEnabled = "is_autoemit_enabled";
	}
	...
	private static readonly StringName NativeName = "FmodAudioSampleEmitter";
	...
	{
		get => (bool)_object.Get(PropertyName.AutoEmit);
		set => _object.Set(PropertyName.AutoEmit, value);
	}
	...
	{
		_object.Call(MethodName.SetAutoEmit, @enable);
	}

	public bool IsAutoemitEnabled()
	{
		return (bool)_object.Call(MethodName.IsAutoemitEnabled);
	}
