...
public class FmodAudioStream
{
	// Engine object used for calling engine methods
	protected Resource _object;

	public FmodAudioStream() : this(NativeName)
	{
	}
	protected FmodAudioStream(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected FmodAudioStream(Variant variant) : this((Resource) variant)
	{
	}
	protected FmodAudioStream([NotNull] Resource @object)
	{
		_object = @object;
	}

	public static implicit operator Resource(FmodAudioStream self) => self?._object;
	public static implicit operator Variant(FmodAudioStream self) => self?._object;
	public static explicit operator FmodAudioStream(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;

	public class PropertyName : Resource.PropertyName
	{
		public static readonly StringName AudioData = "audio_data";
		public static readonly StringName ModeFlags = "mode_flags";
	}

	public class MethodName : Resource.MethodName
	{
		public static readonly StringName SetAudioData = "set_audio_data";
		public static readonly StringName GetAudioData = "get_audio_data";
		public static readonly StringName SetModeFlags = "set_mode_flags";
		public static readonly StringName GetModeFlags = "get_mode_flags";
		public static readonly StringName GetSound = "get_sound";
		public static readonly StringName GetLength = "get_length";
		public static readonly StringName IsDataLoaded = "is_data_loaded";
	...
	private static readonly StringName NativeName = "FmodAudioStream";

	#region Enums

	public enum CreateMode : long
	{
		Default = 0L,
		Stream = 1L,
		Sample = 2L,
	...
	{
		get => (byte[])_object.Get(PropertyName.AudioData);
		set => _object.Set(PropertyName.AudioData, value);
	}

	public int ModeFlags
	{
		get => (int)_object.Get(PropertyName.ModeFlags);
		set => _object.Set(PropertyName.ModeFlags, value);
	}
	...
	{
		_object.Call(MethodName.SetAudioData, @data);
	}

	public byte[] GetAudioData()
	{
		return (byte[])_object.Call(MethodName.GetAudioData);
	}

	public void SetModeFlags(int @flags)
	{
		_object.Call(MethodName.SetModeFlags, @flags);
	}

	public int GetModeFlags()
	{
		return (int)_object.Call(MethodName.GetModeFlags);
	}

	public FmodSound GetSound()
	{
		return (FmodSound)_object.Call(MethodName.GetSound);
	}

	public float GetLength()
	{
		return (float)_object.Call(MethodName.GetLength);
	}

	public bool IsDataLoaded()
	{
		return (bool)_object.Call(MethodName.IsDataLoaded);
	}
	...
	public static FmodAudioStream LoadFromFile(string @path, int @flags = 1)
	{
		return (FmodAudioStream)ClassDB.ClassCallStatic(NativeName, MethodName.LoadFromFile, @path, @flags);
	}
