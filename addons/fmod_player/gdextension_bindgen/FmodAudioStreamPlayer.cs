...
public class FmodAudioStreamPlayer
{
	// Engine object used for calling engine methods
	protected Node _object;

	public FmodAudioStreamPlayer() : this(NativeName)
	{
	}
	protected FmodAudioStreamPlayer(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected FmodAudioStreamPlayer(Variant variant) : this((Node) variant)
	{
	}
	protected FmodAudioStreamPlayer([NotNull] Node @object)
	{
		_object = @object;
	}

	public static implicit operator Node(FmodAudioStreamPlayer self) => self?._object;
	public static implicit operator Variant(FmodAudioStreamPlayer self) => self?._object;
	public static explicit operator FmodAudioStreamPlayer(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	public class PropertyName : Node.PropertyName
	{
		...
		public static readonly StringName AutoPlay = "auto_play";
	...
	public class MethodName : Node.MethodName
	{
		...
		public static readonly StringName SetPlaying = "set_playing";
		...
		public static readonly StringName SetAutoPlay = "set_auto_play";
	...
	private static readonly StringName NativeName = "FmodAudioStreamPlayer";

	#region Properties

	public FmodAudioStream Stream
	{
		get => (FmodAudioStream)_object.Get(PropertyName.Stream);
		set => _object.Set(PropertyName.Stream, value);
	}

	public bool Playing
	{
		get => (bool)_object.Get(PropertyName.Playing);
		set => _object.Set(PropertyName.Playing, value);
	}

	public bool StreamPaused
	{
		get => (bool)_object.Get(PropertyName.StreamPaused);
		set => _object.Set(PropertyName.StreamPaused, value);
	}
	...
	public Godot.StringName Bus
	{
		get => (Godot.StringName)_object.Get(PropertyName.Bus);
		set => _object.Set(PropertyName.Bus, value);
	}
	...
	public void Play(float @from_position = 0.0f)
	{
		_object.Call(MethodName.Play, @from_position);
	}

	public void Seek(float @to_position)
	{
		_object.Call(MethodName.Seek, @to_position);
	}
	...
	{
		_object.Call(MethodName.SetPlaying, @playing);
	}
	...
	public void SetStreamPaused(bool @paused)
	{
		_object.Call(MethodName.SetStreamPaused, @paused);
	}

	public bool GetStreamPaused()
	{
		return (bool)_object.Call(MethodName.GetStreamPaused);
	}

	public float GetPlaybackPosition()
	{
		return (float)_object.Call(MethodName.GetPlaybackPosition);
	}
	...
	{
		_object.Call(MethodName.SetAutoPlay, @enable);
	}

	public bool IsAutoplayEnabled()
	{
		return (bool)_object.Call(MethodName.IsAutoplayEnabled);
	}

	public void SetBus(Godot.StringName @bus)
	{
		_object.Call(MethodName.SetBus, @bus);
	}

	public Godot.StringName GetBus()
	{
		return (Godot.StringName)_object.Call(MethodName.GetBus);
	}
	...
	public event Action Finished
	{
		add
		{
			Connect(SignalName.Finished, Callable.From(value));
		}
		remove
		{
			Disconnect(SignalName.Finished, Callable.From(value));
		}
	}
