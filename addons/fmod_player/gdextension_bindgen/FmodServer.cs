...
public class FmodServer
{
	...
	protected FmodServer(Variant variant) : this((Object) variant)
	{
	}
	protected FmodServer([NotNull] Object @object)
	{
		_object = @object;
	}

	public static implicit operator Object(FmodServer self) => self?._object;
	public static implicit operator Variant(FmodServer self) => self?._object;
	...
	public class MethodName : Object.MethodName
	{
		...
		public static readonly StringName GetMainSystem = "get_main_system";
		public static readonly StringName GetMasterChannelGroup = "get_master_channel_group";
		public static readonly StringName GetAudioBusLayout = "get_audio_bus_layout";
	}
	...
	public static FmodServer GetSingleton()
	{
		return (FmodServer)ClassDB.ClassCallStatic(NativeName, MethodName.GetSingleton);
	}

	public static FmodSystem GetMainSystem()
	{
		return (FmodSystem)ClassDB.ClassCallStatic(NativeName, MethodName.GetMainSystem);
	}

	public static FmodChannelGroup GetMasterChannelGroup()
	{
		return (FmodChannelGroup)ClassDB.ClassCallStatic(NativeName, MethodName.GetMasterChannelGroup);
	}

	public static FmodAudioBusLayout GetAudioBusLayout()
	{
		return (FmodAudioBusLayout)ClassDB.ClassCallStatic(NativeName, MethodName.GetAudioBusLayout);
	}
