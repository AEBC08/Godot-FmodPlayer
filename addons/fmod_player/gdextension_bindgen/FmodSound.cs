...
public class FmodSound
{
	...
	public FmodSound() : this(NativeName)
	{
	}
	protected FmodSound(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected FmodSound(Variant variant) : this((RefCounted) variant)
	{
	}
	protected FmodSound([NotNull] RefCounted @object)
	{
		_object = @object;
	}

	public static implicit operator RefCounted(FmodSound self) => self?._object;
	public static implicit operator Variant(FmodSound self) => self?._object;
	public static explicit operator FmodSound(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	public class MethodName : RefCounted.MethodName
	{
		...
		public static readonly StringName GetNumTags = "get_num_tags";
		public static readonly StringName GetTag = "get_tag";
		public static readonly StringName GetOpenState = "get_open_state";
		public static readonly StringName ReadData = "read_data";
		public static readonly StringName SeekData = "seek_data";
		public static readonly StringName Lock = "lock";
		public static readonly StringName GetMusicNumChannels = "get_music_num_channels";
		public static readonly StringName SetMusicChannelVolume = "set_music_channel_volume";
		public static readonly StringName GetMusicChannelVolume = "get_music_channel_volume";
		public static readonly StringName SetMusicSpeed = "set_music_speed";
		public static readonly StringName GetMusicSpeed = "get_music_speed";
		public static readonly StringName GetSyncPoint = "get_sync_point";
		public static readonly StringName GetSyncPointInfo = "get_sync_point_info";
		public static readonly StringName GetNumSubSounds = "get_num_sub_sounds";
	}
	...
	private static readonly StringName NativeName = "FmodSound";

	#region Enums

	public enum FmodSoundType : long
	{
		Unknown = 0L,
		AIFF = 1L,
		ASF = 2L,
	...
	public enum FmodSoundFormat : long
	{
		None = 0L,
		PCM8 = 1L,
		PCM16 = 2L,
	...
	public enum FmodTagDataType : long
	{
		Binary = 0L,
		Int = 1L,
		Float = 2L,
	...
	public enum FmodOpenState : long
	{
		Ready = 0L,
		Loading = 1L,
		Error = 2L,
	...
	public static FmodSound LoadFromFile(string @path)
	{
		return (FmodSound)ClassDB.ClassCallStatic(NativeName, MethodName.LoadFromFile, @path);
	}
	...
	public Godot.Collections.Dictionary GetFormat()
	{
		return (Godot.Collections.Dictionary)_object.Call(MethodName.GetFormat);
	}

	public float GetLength(FmodSystem.FmodTimeUnit @time_unit = (FmodSystem.FmodTimeUnit)1)
	{
		return (float)_object.Call(MethodName.GetLength, (int)@time_unit);
	}

	public Godot.Collections.Dictionary GetNumTags()
	{
		return (Godot.Collections.Dictionary)_object.Call(MethodName.GetNumTags);
	}

	public Godot.Collections.Dictionary GetTag(int @index, string @name = "")
	{
		return (Godot.Collections.Dictionary)_object.Call(MethodName.GetTag, @index, @name);
	}

	public Godot.Collections.Dictionary GetOpenState()
	{
		return (Godot.Collections.Dictionary)_object.Call(MethodName.GetOpenState);
	}

	public byte[] ReadData(int @length)
	{
		return (byte[])_object.Call(MethodName.ReadData, @length);
	}

	public void SeekData(int @pcm)
	{
		_object.Call(MethodName.SeekData, @pcm);
	}

	public FmodSoundLock Lock(int @offset, int @length)
	{
		return (FmodSoundLock)_object.Call(MethodName.Lock, @offset, @length);
	}

	public int GetMusicNumChannels()
	{
		return (int)_object.Call(MethodName.GetMusicNumChannels);
	}

	public void SetMusicChannelVolume(int @channel, float @volume_db)
	{
		_object.Call(MethodName.SetMusicChannelVolume, @channel, @volume_db);
	}

	public float GetMusicChannelVolume(int @_unnamed_arg0)
	{
		return (float)_object.Call(MethodName.GetMusicChannelVolume, @_unnamed_arg0);
	}

	public void SetMusicSpeed(float @speed)
	{
		_object.Call(MethodName.SetMusicSpeed, @speed);
	}

	public float GetMusicSpeed()
	{
		return (float)_object.Call(MethodName.GetMusicSpeed);
	}

	public int GetSyncPoint(int @index)
	{
		return (int)_object.Call(MethodName.GetSyncPoint, @index);
	}

	public Godot.Collections.Dictionary GetSyncPointInfo(int @point, FmodSystem.FmodTimeUnit @time_unit = (FmodSystem.FmodTimeUnit)1)
	{
		return (Godot.Collections.Dictionary)_object.Call(MethodName.GetSyncPointInfo, @point, (int)@time_unit);
	}

	public int GetNumSubSounds()
	{
		return (int)_object.Call(MethodName.GetNumSubSounds);
	}
