...
public class FmodSoundLock
{
	// Engine object used for calling engine methods
	protected RefCounted _object;

	public FmodSoundLock() : this(NativeName)
	{
	}
	protected FmodSoundLock(StringName @class) : this(ClassDB.Instantiate(@class))
	{
	}
	protected FmodSoundLock(Variant variant) : this((RefCounted) variant)
	{
	}
	protected FmodSoundLock([NotNull] RefCounted @object)
	{
		_object = @object;
	}

	public static implicit operator RefCounted(FmodSoundLock self) => self?._object;
	public static implicit operator Variant(FmodSoundLock self) => self?._object;
	public static explicit operator FmodSoundLock(Variant variant) => variant.AsGodotObject() != null ? new(variant) : null;
	...
	public class MethodName : RefCounted.MethodName
	{
		...
		public static readonly StringName GetData1 = "get_data1";
		public static readonly StringName GetData2 = "get_data2";
	...
	private static readonly StringName NativeName = "FmodSoundLock";

	#region Methods

	public void Unlock()
	{
		_object.Call(MethodName.Unlock);
	}

	public byte[] GetData1()
	{
		return (byte[])_object.Call(MethodName.GetData1);
	}

	public byte[] GetData2()
	{
		return (byte[])_object.Call(MethodName.GetData2);
	}

	public bool IsLocked()
	{
		return (bool)_object.Call(MethodName.IsLocked);
	}
